...
class PinocchioControllerAcceleration(object):
    ...
    def controlLfRfCom(self,Lf=[0.0,0.0,0.0],Rf=[0.0,0.0,0.0],dLf=[0.0,0.0,0.0],dRf=[0.0,0.0,0.0],Com=[0,0,0.63],K=1.0):
        def robotint(q,dq):
        ...
        errRf,errRfDyn = errorInSE3dyn(SE3_RF,self.robot.Mrf(self.q),v_frame,v_ref)
    ...
    #_TASK2 STACK_______________________________________________________
        ...
        self.robot.viewer.gui.refresh()
        return self.robot.com(self.q) ,errRf, errRfDyn
